...
public class CostcoWaitTest {
	public static void main(String[] args) {
		WebDriver driver = Keywords.startTestOnChrome("https://www.costco.com/");
		WebDriverWait wait = new WebDriverWait(driver, 30);
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(
				"//a[@href='/CatalogSearch?dept=All&keyword=appleseptmvm19'][@role='tabpanel'][@aria-hidden='false']")));
		...
		String cartItemNumber = driver.findElement(By.xpath("//div[@class='order-item']"))
				.getAttribute("data-orderitemnumber");
